...
var validator = (function($){
    ...
    */
    message = {
        ...
        empty           : 'mettez quelque chose ici',
        min             : 'l\'entrée est trop courte',
        max             : 'l\'entrée est trop longue',
        number_min      : 'trop bas',
        number_max      : 'trop haut',
        url             : 'URL invalide',
        number          : 'pas un nombre',
        email           : 'l\'adresse email est invalide',
        email_repeat    : 'les e-mails ne correspondent pas',
        password_repeat : 'les mots de passe ne correspondent pas',
        repeat          : 'pas de correspondance',
        complete        : 'entrée n\'est pas complète',
